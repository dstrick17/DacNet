...
class DenseNetTransformer(nn.Module):
    def __init__(self, num_classes=14, hidden_dim=512, nhead=8, num_layers=2):
        ...
        # Use earlier features for finer spatial information
        self.feature_extractor = nn.Sequential(
            base_model.features[:6],  # Outputs [B, 256, 28, 28]
            nn.Conv2d(256, hidden_dim, 1)  # Reduce channels to hidden_dim
        )
    ...
    def forward(self, x):
        # Extract features with higher spatial resolution
